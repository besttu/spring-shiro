	...
	<div class="wrapper">
			...
			<ul class="nav navbar-nav">
								...
								<li>
									<!-- start message --> <a href="#">
										<div class="pull-left">
											<!-- User Image -->
											<img src=""
												class="img-circle u_img" alt="User Image">
				...
				<li class="dropdown user user-menu">
					...
					data-toggle="dropdown"> <!-- The user image in the navbar--> <img 
						src="" class="user-image u_img"
						alt="User Image"> <!-- hidden-xs hides the username on small devices so only the image appears. -->
						<span class="hidden-xs u_name">Alexander Pierce</span>
				</a>
					<ul class="dropdown-menu">
						<!-- The user image in the menu -->
						<li class="user-header"><img
							src="" class="img-circle  u_img"
							alt="User Image">
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img class="u_img" src="" class="img-circle"
					alt="User Image">
			</div>
			<div class="pull-left info">
				<p class="u_name">Alexander Pierce</p>
				<!-- Status -->
		...
		<!-- /.search form --> <!-- Sidebar Menu --> <!-- sidebar menu: : style can be found in sidebar.less -->
					...
					$.get("/admin/getTree", function(data) {
						...
						if(data.children){
							...
							$.each(data.children,function(i,d){
								childrenText+=("<li>"+
											"<a href='"+d.url+"'><i class='"+d.icon+"'></i>"+d.menuname+"</a>"+
										"</li>")
							})
						childrenText+="</ul>"
						}var active=""
							...
							leftText+=	("<li class='"+active+" treeview'><a href='"+data.sysMenu.url+"'>"
									+" <i class='"+data.sysMenu.icon+"''></i><span>"+data.sysMenu.menuname+"</span>"+
									" <span class='pull-right-container'> <i"+
							"class='fa fa-angle-left pull-right'></i></span></a>"+childrenText+"</li>")
						})
